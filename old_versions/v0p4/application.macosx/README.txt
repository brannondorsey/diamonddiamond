...
Diamond Diamond Version 0.4 Limited Beta, 3/31/13


//----------------ABOUT-------------------

Diamond Diamond is a free artware tool that allows users to create poetic images using their own language and pictures. It aims to incorporate a balance of randomness and control over its content, leading users to draw inspiration from and make associations with imagery and language in new ways. 
...
We are currently working on a gallery of images created with Diamond Diamond. Please send any and all images you like (or even the ones you don't) to brannon@brannondorsey.com with "Diamond Diamond Submission" as the subject. Until we have a site up I will be personally reviewing, and probably posting, all images. We really like Diamond Diamond and we hope that you will to! Please share it with anyone you want to so that more people can like it too!
...
In order to meet these image specifications an Adobe Photoshop droplet name "resize" has been included with your copy of Diamond Diamond. If you have Photoshop (version required unknown) simply drag the images you want to use on top of the "resize" file and they will be properly resized and saved to your desktop. If you do not have access to photoshop or the droplet did not work there are plenty of online resize tool like http://www.picresize.com/ for you to use. 
